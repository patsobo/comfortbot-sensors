 ...
 * Note: Connect AIN0 to any constant voltage to check that it is stream
 *       correctly.
**/
...
int main(int argc, char * argv[])
{
	...
	test.handle = OpenOrDie(LJM_dtT7, LJM_ctUSB, "LJM_idANY");
	printf("\n");
...
void StreamBurst(StreamTest test)
{
	...
	while (err == LJME_NOERROR) {
		...
		totalSkippedScans += CountAndOutputNumSkippedScans(test.numChannels,
